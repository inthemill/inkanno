...
public abstract class ImagePixelAccurateDrawer extends RegisteredImageExportDrawer {
	...
	protected boolean parentEquals(InkTraceView view, String string) {
		return view.getParent().containsAnnotation(InkAnnoAnnotationStructure.TYPE) 
		&& view.getParent().getAnnotation(InkAnnoAnnotationStructure.TYPE).equalsIgnoreCase(string);
	}
